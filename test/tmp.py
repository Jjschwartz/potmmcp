...
if __name__ == "__main__":
    ...
    obs_space = single_dummy_env.observation_space("player_0")
    act_space = single_dummy_env.action_space("player_0")
    ...
    for i in range(args.stop_iters):
        ...
        dqn_trainer.set_weights(ppo_trainer.get_weights(["pi_0"]))
        ppo_trainer.set_weights(dqn_trainer.get_weights(["pi_1"]))
