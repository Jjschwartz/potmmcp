...
PE_PURSUER_EXP_PARAMS = EnvExperimentParams(
    env_id=ENV_ID,
    n_agents=2,
    num_actions=4,
    env_step_limit=100,
    ...
    # meta policy
    policy_prior_map={
        (f"{ENV_ID}/klr_k0_seed{POLICY_SEED}_i0-v0", "-1"): 1 / 4,
        (f"{ENV_ID}/klr_k1_seed{POLICY_SEED}_i0-v0", "-1"): 1 / 4,
        (f"{ENV_ID}/klr_k2_seed{POLICY_SEED}_i0-v0", "-1"): 1 / 4,
        (f"{ENV_ID}/klr_k3_seed{POLICY_SEED}_i0-v0", "-1"): 1 / 4,
    },
...
if __name__ == "__main__":
    run_env_experiments(PE_PURSUER_EXP_PARAMS)
