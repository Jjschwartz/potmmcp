...
* BAPOSGMCP memory usage

Trying to determine the memory usage for each BAPOSGMCP KLR experiment.

Based on slurm messages, usage was around 19GB for BAPOSGMCP using 10 cores and 1024 sims. Memory usage decreased with num sims, down to less than 8 GB for 10 cores using 8 sims.
